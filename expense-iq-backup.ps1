...
# TODO: implement as a function (Decode-ExpenseIqBackup)
# Decoding the whole file
$strBackupPath = 'D:\Users\Aleksey\Clouds\Google Drive\2018-07-09 18.00.26.bak';
$arrLines = Get-Content -Path $strBackupPath;
...
for ( $idxLine = 1; $idxLine -lt $arrLines.Count; $idxLine ++ ) {
    ...
    $arrSqlQueries += $strSqlQuery;
}

$arrSqlQueries | Out-File -Force -Encoding utf8 -LiteralPath 'D:\tmp\expense-iq.sql';